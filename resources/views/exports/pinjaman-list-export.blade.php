    ...
    <div class="mx-auto my-8 max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="bg-dark overflow-hidden rounded-lg shadow-lg">
            <div class="bg-accent/10 border-b border-gray-200 px-6 py-8">
                <h1 class="text-accent text-center text-3xl font-bold">Daftar Pinjaman</h1>
                <p class="mt-2 text-center text-gray-600">
                    Total: {{ count($pinjaman) }} Pinjaman
                </p>
            </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th class="font-sans">Jumlah Pinjaman</th>
                                <th class="font-sans">Angsuran Perbulan</th>
                                <th class="font-sans">Bunga Perbulan</th>
                                <th class="font-sans">Total Pinjaman</th>
                                <th class="font-sans">Status</th>
                                <th class="font-sans">Tanggal</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($pinjaman as $p)
                                <tr>
                                    ...
                                    <td>{{ $p->angsuran_per_bulan }}</td>
                                    <td>{{ $p->bunga_per_bulan }}</td>
                                    <td>{{ $p->total_peminjaman }}</td>
                                    <td>{{ $p->status }}</td>
