            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    @if ((auth()->check() && auth()->user()->hasRole('ketua')) || (auth()->check() && auth()->user()->hasRole('admin')))
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'Saham' ? '':'Saham')"
                                class="menu-item group"
                                ...
                                <svg class="menu-item-arrow"
                                    :class="[(selected === 'Saham') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                        sidebarToggle ? 'lg:hidden' : ''
                                    ]"
                                    width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- <li>
                            ...
                            <a href="/shu" @click="selected = (selected === 'SHU' ? '':'SHU')"
                                class="menu-item group"
