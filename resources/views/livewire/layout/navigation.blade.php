...
<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html" class="flex w-full flex-col items-center justify-center">
            ...
            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="{{ asset('assets/logo.png') }}"
                alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    @if ((auth()->check() && auth()->user()->hasRole('admin')) || (auth()->check() && auth()->user()->hasRole('admin')))
                     <li>
                            <a href="/shu" @click="selected = (selected === 'Saham' ? '':'Saham')"
                                class="menu-item group"
                                :class="(selected === 'Saham') && (page === 'profile') ? 'menu-item-active' :
                                'menu-item-inactive'">
                                <svg :class="(selected === 'Saham') && (page === 'profile') ? 'menu-item-icon-active' :
                                'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        {{-- <li>
                            <a href="/shu-list" @click.prevent="selected = (selected === 'Saham' ? '':'Saham')"
                                class="menu-item group"
                                :class="(selected === 'Saham') || (page === 'ecommerce' || page === 'analytics' ||
                                    page === 'marketing' || page === 'crm' || page === 'stocks') ?
                                'menu-item-active' : 'menu-item-inactive'">
                                <svg :class="(selected === 'Saham') || (page === 'ecommerce' || page === 'analytics' ||
                                    page === 'marketing' || page === 'crm' || page === 'stocks') ?
                                'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
