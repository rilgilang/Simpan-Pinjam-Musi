    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden" src={{ asset('build/assets/logo.svg') }} alt="Logo" />
                <img class="hidden dark:block" src={{ asset('build/assets/logo.svg') }} alt="Logo" />
            </span>
                    ...
                    <li>
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                <li>
                                    <a href="task-list.html" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                <li>
                                    <a href="file-manager.html" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="500.html" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="503.html" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="coming-soon.html" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="maintenance.html" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="success.html" class="menu-dropdown-item group"
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Email' ? '':'Email')"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Email') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'UiElements' ? '':'UiElements')"
                            ...
                            :class="(selected === 'UiElements') || (page === 'alerts' || page === 'avatars' ||
                                ...
                                page === 'tooltips' || page === 'videos') ? 'menu-item-active' :
                            'menu-item-inactive'">
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="pagination.html" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="advanced-chart.html" class="menu-dropdown-item group"
                                        :class="page === 'advancedChart' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Advanced Chart
                                        <span class="absolute right-3 flex items-center gap-1">
                                            <span class="menu-dropdown-badge"
                                                :class="page === 'advancedChart' ? 'menu-dropdown-badge-active' :
                                                    'menu-dropdown-badge-inactive'">
                                                Pro
                                            </span>
                                        </span>
